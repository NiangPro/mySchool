...
<div id="edit" wire:ignore.self class="modal fade" tabindex="-1" role="dialog"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center mt-2 mb-4">
                    <span class="text-capitalize">{{__('messages.form.editrole')}}</span>
                ...
                <form method="POST" wire:submit.prevent="update">
                    ...
                    <div class="form-group pt-2">
                        <button class="btn btn-outline-success">{{__('messages.btn.edit')}}</button>
                    </div>
                </form>
            </div>
        </div><!-- /.modal-content -->
