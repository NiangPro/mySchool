...
class Teacher extends Component
{
    ...
    public function store()
    {
        ...
        $role = Role::where('slug', 'enseignant')->first();
        ...
        $this->dispatchBrowserEvent('teacherAdded');
        $this->etat = "list";
    }
    ...
    public function update()
    {
        ...
        $this->user = $user;
        $this->dispatchBrowserEvent('teacherUpdated');
    }
    ...
    public function delete($id)
    {
        ...
        $this->dispatchBrowserEvent("teacherDeleted");
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.teacher.teacher', [
            "teachers" => $users->enseignants()
        ])->layout('layouts.app', [
            'page' => "teacher"
        ]);
    }
